...
Stadium::Stadium(const std::string& adress, const std::string& club, const int& capacity, const int& sectorsAmount)
{
    adress_ = adress;
    club_ = club;
    capacity_ = capacity;
...
{
    attendance_ = (100 * visitors) / (float)capacity_;
}
